<template>
  <div class="about">
    <div class="container">
      <h1 class="text-center mt-3 text-white">Information</h1>
      <div class="row mt-3">
              ...
              <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse bg-dark" aria-labelledby="flush-headingOne" data-bs-parent="#accordion1">
                  <div class="accordion-body text-white">
                    ...
                    <br />
                    <img class="rounded mx-auto d-block img-fluid" src="../assets/cards.png">
                  </div>
                </div>
              </div>
            </div>
      ...
      <h1 class="text-center mt-3 text-white">Instructions</h1>
      <div class="row">
        <div class="col-md-6 col-sm-12">
          <div class="card card-body bg-dark">
          ...
          <div class="card mt-3 card-body bg-dark ">
                ...
                <div id="cah-carousel" class="carousel slide" data-bs-ride="carousel">
                  ...
                  <div class="carousel-inner" align="center" style="background-color: lightgray">
                    <div class="carousel-item active">
                      <img class="img-fluid d-block w-75 rounded" src="../assets/1.png">
                      <div class="carousel-caption d-none d-md-block">
                        <h5>select player number </h5>
                      </div>
                    </div>
                    <div class="carousel-item">
                      <img class="img-fluid d-block w-75 rounded" src="../assets/2.png">
                      <div class="carousel-caption d-none d-md-block">
                        <h5 class="text-black">add own cards</h5>
                      </div>
                    </div>
                    <div class="carousel-item">
                      <img class="img-fluid d-block w-75 rounded" src="../assets/3.png">
                      <div class="carousel-caption d-none d-md-block">
                        <h5 class="text-black">add player names</h5>
                      </div>
                    </div>
                    <div class="carousel-item">
                      <img class="img-fluid d-block w-75 rounded" src="../assets/4.png">
                      <div class="carousel-caption d-none d-md-block">
                        <h5>play!</h5>
                      </div>
                    </div>
